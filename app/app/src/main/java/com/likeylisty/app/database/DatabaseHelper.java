...
public class DatabaseHelper extends SQLiteOpenHelper {
  ...
  public DatabaseHelper(@Nullable Context context) {
    super(context, DatabaseDetails.Database.DATABASE_NAME, null,
        DatabaseDetails.Database.DATABASE_VERSION);
  }
  ...
  public void updateItem(int itemId, String newItemText) {
    ...
    db.update(DatabaseDetails.Item.TABLE_NAME, cv, DatabaseDetails.Item.COLUMN_ITEM_ID + "=?",
        new String[]{String.valueOf(itemId)});
  }

  public void deleteItem(int itemId) {
    db = this.getWritableDatabase();
    db.delete(DatabaseDetails.Item.TABLE_NAME, DatabaseDetails.Item.COLUMN_ITEM_ID + "=?",
        new String[]{String.valueOf(itemId)});
  }
